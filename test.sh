...
python3 src/idrive-tagging.py D01692572940000295373 //
python3 src/idrive-tagging.py D01692572940000295373 //Volumes
python3 src/idrive-tagging.py D01692572940000295373 //Volumes/Extreme\ Pro
...
# ASUS
python3 src/idrive-tagging.py D01567232251000246054 //
python3 src/idrive-tagging.py D01567232251000246054 //C
python3 src/idrive-tagging.py D01567232251000246054 //C/DELL1TB02
python3 src/idrive-tagging.py D01567232251000246054 //C/RAID2
...
# iPhone (3)
python3 src/idrive-tagging.py R01607197738000636951 //
